...
program logp1ex3 !nome do programa (programa fonte logp1ex3)
...
!SAÍDA DE DADOS PARA ARQUIVO
    open(10,file='ex3.dat',status='replace') !abertura de arquivo ex3.dat
...
end program logp1ex3 !a instrução program logp1ex3 não é necessária